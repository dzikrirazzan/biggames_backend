...
async def seed_menu_items(db: AsyncSession) -> dict:
    ...
    menu_data = [
        ...
        {"name": "Es Teh Manis", "description": "Teh manis dingin", "category": MenuCategory.DRINK, "price": Decimal("8000"), "stock": 100},
        {"name": "Es Jeruk", "description": "Jeruk peras segar", "category": MenuCategory.DRINK, "price": Decimal("10000"), "stock": 80},
        {"name": "Kopi Susu", "description": "Kopi susu gula aren", "category": MenuCategory.DRINK, "price": Decimal("18000"), "stock": 60},
        {"name": "Coca Cola", "description": "Coca Cola dingin 330ml", "category": MenuCategory.DRINK, "price": Decimal("12000"), "stock": 100},
        {"name": "Mineral Water", "description": "Air mineral 600ml", "category": MenuCategory.DRINK, "price": Decimal("6000"), "stock": 200},
